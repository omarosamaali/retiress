        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name_ar" name="name_ar" value="{{ old('name_ar', $member->name_ar) }}" required>
                    @error('name_ar')
 ...
 <div class="col-md-6">
     <div class="mb-3">
         ...
         <select class="form-select" name="council_id" id="councils">
             ...
             <option value="{{ $council->id }}" @selected($council->id == old('council_id', $memberApplication->council_id ?? ''))>
                 {{ $council->name_ar }}
             </option>
             @endforeach
         </select>
 ...
 <div class="col-md-6">
     <div class="mb-3">
         ...
         <select class="form-select" name="committee_id" id="committees">
             ...
             <option value="{{ $committee->id }}" @selected($committee->id == old('committee_id', $memberApplication->committee_id ?? ''))>
                 {{ $committee->name_ar }}
             </option>
             @endforeach
         </select>
         ...
         @enderror
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    @enderror
                    @if ($member->image)
                    <img id="current_image_preview" src="{{ $member->image_url }}" alt="الصورة الحالية" class="about-preview mt-2 p-2 current-image-preview">
