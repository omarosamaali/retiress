...
@section('title', 'إدارة صفحة الأعضاء')
@section('page-title', 'إدارة صفحة الأعضاء')
...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.member.create') }}" class="btn btn-success btn-sm">إضافة اعضاء</a>
        </div>
        <div class="card-body">
                ...
                <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <img src="/assets/images/default_user.jpg" alt="{{ $member->name_ar }}" class="about-img">
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="{{ route('admin.member.edit', $member->id) }}" class="btn btn-warning btn-sm" title="تعديل">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted mt-2">لا يوجد اعضاء بعد. يرجى <a href="{{ route('admin.member.create') }}">الإضافة الآن</a></p>
                        </div>
                    @endif
                </table>
            </div>
