...
@section('page-title', 'تعديل المجلس')
...
<div class="add-section">
    <h5 class="mb-4">
        ...
        تعديل صفحة معلومات اللجنه: {{ $council->name_ar }}
    </h5>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name_ar" name="name_ar" value="{{ old('name_ar', $council->name_ar) }}" required>
                    @error('name_ar')
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" id="description_ar" name="description_ar" required>{{ $council->description_ar }}</textarea>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    @if ($council->image)
                    <img id="current_image_preview" src="{{ asset('storage/' . $council->image) }}" alt="الصورة الحالية" class="about-preview mt-2">
                    @endif
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select class="form-select" name="status" id="status" required>
                        <option value="1" {{ old('status', $council->status) == '1' ? 'selected' : '' }}>فعال
                        </option>
                        <option value="0" {{ old('status', $council->status) == '0' ? 'selected' : '' }}>غير
                            فعال</option>
                    </select>
                    @error('status')
                    <div class="text-black">{{ $message }}</div>
