            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        @error('main_image')
                            <div class="text-black">{{ $message }}</div>
                        @enderror
                        <img id="main_image_preview" src="#" alt="معاينة الصورة الجديدة" class="about-preview mt-2" style="display: none;">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <img id="sub_image_preview" src="#" alt="معاينة الصورة الجديدة" class="about-preview mt-2" style="display: none;">
                    </div>
                </div>
