            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select class="form-select" name="section" id="section" required>
                        <option value="" disabled {{ old('section') ? '' : 'selected' }}>اختر نوع القسم</option>
                        <option value="membership_description" {{ old('section') == 'membership_description' ? 'selected' : '' }}>وصف العضوية</option>
                        <option value="privileges" {{ old('section') == 'privileges' ? 'selected' : '' }}>امتيازات العضوية</option>
                        <option value="target_audience" {{ old('section') == 'target_audience' ? 'selected' : '' }}>الجمهور المستهدف</option>
                        <option value="required_documents" {{ old('section') == 'required_documents' ? 'selected' : '' }}>الوثائق المطلوبة</option>
                        <option value="subscription_months" {{ old('section') == 'subscription_months' ? 'selected' : '' }}>عدد أشهر الاشتراك</option>
                        <option value="value" {{ old('section') == 'value' ? 'selected' : '' }}>القيمة</option>
                    </select>
                    @error('section')
