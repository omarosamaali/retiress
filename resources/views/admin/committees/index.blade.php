...
@section('title', 'إدارة صفحة اللجان')
@section('page-title', 'إدارة صفحة اللجان')
                ...
                <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('admin.committee.show', $committee->id) }}" class="btn btn-info btn-sm" title="عرض">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.committee.edit', $committee->id) }}" class="btn btn-warning btn-sm" title="تعديل">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button class="btn btn-danger btn-sm" title="حذف" onclick="confirmDeleteModal('committees', {{ $committee->id }})">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted mt-2">لا يوجد لجان بعد. يرجى <a href="{{ route('admin.committee.create') }}">الإضافة الآن</a></p>
                        </div>
                    @endif
                </table>
            </div>
...
@push('scripts')
    <script>
        ...
        function confirmDeleteModal(type, id) {
            ...
            deleteForm.action = `/admin/committee/${id}`;
