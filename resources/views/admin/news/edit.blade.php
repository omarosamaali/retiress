    ...
    <div class="add-section">
        ...
        <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        <label for="youtube_url" class="form-label font-bold">
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        <label class="form-label font-bold">وصف الأخبار (بالعربية)</label>
                        <div class="ql-wrapper"><div id="quill_description_ar"></div></div>
                        <textarea id="description_ar" name="description_ar" style="display:none;">{{ old('description_ar', $news->description_ar) }}</textarea>
