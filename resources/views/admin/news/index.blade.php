    ...
    <div class="add-section">
        ...
        <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="title_ar" class="form-label">عنوان الأخبار (بالعربية)</label>
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        <label for="description_ar" class="form-label">وصف الأخبار (بالعربية)</label>
            ...
            <tbody>
                @forelse($news ?? [] as $item)
                    <tr>
                        ...
                        <td>
                            @if ($item->main_image)
                                <img src="{{ Storage::url($item->main_image) }}" alt="{{ $item->title_ar }}" class="news-img">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    هل أنت متأكد من حذف هذه الأخبار؟
                </div>
