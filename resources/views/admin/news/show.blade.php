        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="detail-item">
                    ...
                    <span class="badge text-white {{ $news->status_badge_class ?? ($news->status == 1 ? 'bg-success' : 'bg-danger') }}">
            ...
            <div class="col-md-6">
                <div class="detail-item">
                    ...
                    @if ($news->main_image)
                        <img src="{{ $news->main_image_url }}" alt="{{ $news->title_ar }}" class="p-3 detail-image mt-2">
                    @else
                ...
                <div class="detail-item">
                    ...
                    <div class="d-flex">
                        @if ($news->sub_image)
                            @foreach ($news->sub_image_url as $img)
                                <img src="{{ $img }}" alt="{{ $news->title_ar }}" class="p-3 m-2 detail-image mt-2">
                            @endforeach
                        @else
