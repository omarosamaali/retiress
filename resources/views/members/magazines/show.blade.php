                            ...
                            <div class="bg-xf5 shadow-primary-sxe position-1lp">
                                <div class="block-osq text-b1x">
                                    <figure class="m-38w text-m1o overflow-khm">
                                        <img class="img-odq rou-m3b" src="{{ asset('storage/' . $magazines->main_image) }}">
                                    </figure>
                                </div>
                            </div>
                        </div>
                        <div class="col-5vc col-cvg my-mpv">
                            <a class="text-7zo text-b1x" href="?do=v&amp;id={{ $magazines->id }}">
                                <h2 class="qvtmx font-weight-s3h text-7zo">{{ $magazines->title_ar }}</h2>
                            </a>
                            <hr>
                            <div class="my-7z8 fs--oox">
                                <i class="fa fa-calendar"></i> {{ \Carbon\Carbon::parse($magazines->date)->format('Y-m-d') }}
                                <i class="fa fa-calendar"></i> {{ \Carbon\Carbon::parse($magazines->start_time)->format('h:i A') }}
                                {{ \Carbon\Carbon::parse($magazines->end_time)->format('h:i A') }}
                            </div>
                            <p class="mt-1o5 fs--6nj mb-yo9 jus-6kh">
                                <span class="text-7zo block-osq"> {{ $magazines->description_ar }} </span>
                            </p>
                            <p>{{ $magazines->long_description }}</p>
                            <hr>
                            {{-- <div>
