...
<div class="container-w8y">
    <div class="row-x6c">
        <div class="col-83z offset-md-f6v">
            <form class="col-k19 sho-ph8" method="POST" action="{{ route('members.update_password') }}">
                @csrf
                <h1 class="text-o8q xygoj mb-pfh font-weight-dom"> تعيين كلمة المرور </h1>
                <p class="b-r8w"> قم بادخال كلمة المرور الجديدة </p>
                <div class="p-72h rou-kih shadow-eoy">
                    ...
                    <div class="input-3ob">
                        <div class="label-dav input-fja">
                            ...
                            <input placeholder="" id="pas-41r" name="password" type="password" class="form-control-k7o fsbsy" required>
                            <label for="pas-41r">كلمة المرور</label>
                        </div>
                    </div>
                    <div class="input-3ob" style="margin-top: 15px;">
                        <div class="label-dav input-fja">
                            <div class="input-f96">
                                <span class="input-fo3"><i class="fa-evk fa-pp5"></i></span>
                            </div>
                            <input placeholder="" id="pas-41r-confirm" name="password_confirmation" type="password" class="form-control-k7o fsbsy" required>
                            <label for="pas-41r-confirm">تأكيد كلمة المرور </label>
                        </div>
                    </div>
                </div>
