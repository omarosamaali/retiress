        ...
        <section class="py-rzt" style="padding-top: 150px;">
            <div class="container-w8y">
                <div class="col-83z offset-md-f6v">
                    ...
                    @enderror
                    <form class="col-k19 sho-ph8" method="POST" action="{{ route('members.send_otp') }}">
                        @csrf <h1 class="text-o8q xygoj mb-pfh font-weight-dom"> نسيت كلمة المرور </h1>
                        <p class="b-r8w"> أدخل البريد الإلكتروني المرتبط بحسابك </p>
                        <div class="p-72h rou-kih shadow-eoy">
                            <div class="label-dav mb-os5">
                                <input placeholder="ادخل البريد الالكتروني" id="use-v5m" name="email" type="email" class="form-control-k7o fsbsy" required>
                            </div>
