...
<div id="in-cont">
                                            ...
                                            <div class="image-ksy content-zgb vc_-lpq">
                                                <figure class="vc_-ao4">
                                                    <div class="wrapper-j81">
                                                        ...
                                                        <img width="1275" height="743" src="{{ asset('storage/' . $about->main_image) }}" alt="{{ app()->getLocale() == 'ar' ? ($about->title_ar ?? __('app.who_we_are_title')) : ($about->title_en ?? __('app.who_we_are_title')) }}" />
                                                    </div>
                                                </figure>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="column-dx4 content-zgb">
                                                <div>
                                                    ...
                                                    <p style="white-space: pre-line;" dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}" id="style-DRlzk" class="style-DRlzk">
    ...
    @else
    <div>
        {{-- Display message if no 'about' details are available --}}
        {{ __('app.no_about_details') }}
    </div>
    @endif
</div>
