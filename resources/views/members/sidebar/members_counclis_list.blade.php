...
<body>
    ...
    <div id="in-cont">
        ...
        <div style="padding-top: 50px; padding-bottom: 50px;">
            <div style="padding-top: 50px; padding-bottom: 50px;">
                <h3 style="text-align: center; margin-bottom: 10px;">اسم اللجنة : {{ $council->name_ar }}</h3>


                <div class="container-i1t my-kck p-7p2 bg-xf5 shadow-t3k">
                            ...
                            <div class="bg-xf5 shadow-primary-sxe position-1lp">
                                <div class="block-osq text-b1x">
                                    <figure class="m-38w text-m1o overflow-khm">
                                        {{-- الصورة --}}
                                        <img style="height: 180px; width: 100%;" class="img-odq rou-m3b" src="{{ asset('storage/' . $council->image) }}" alt="{{ $council->name_ar ?? 'صورة الخبر' }}">
                                    </figure>
                                </div>
                            </div>
                        </div>
                        <div class="col-5vc col-cvg my-mpv">
                            <d href="{{ url('members/councils_members_list', ['id' => $council->id]) }}" class="block-osq text-b1x">
                                <h2 class="qvtmx font-weight-s3h text-7zo">{{ $council->name_ar }}</h2>
                            </d>
                            <hr>
                            <div class="my-7z8 fs--oox">
                                <i class="fa fa-calendar"></i>
                                {{ \Carbon\Carbon::parse($council->created_at)->translatedFormat('Y-m-d') }}
                                <i class="fa fa-clock" style="margin-right: 15px !important;"></i>
                                {{ \Carbon\Carbon::parse($council->created_at)->translatedFormat('h:i A') }} {{-- تنسيق الوقت صباحا/مساء --}}
                            </div>
                            <p class="mt-1o5 fs--6nj mb-yo9 jus-6kh">
                                <span class="text-7zo block-osq">
                                    {{-- الوصف / المحتوى --}}
                                    {{ \Illuminate\Support\Str::limit($council->description_ar, 250) }} {{-- قطع الوصف لـ 250 حرف --}}
                                </span>
                            </p>
                </div>
            </div>
