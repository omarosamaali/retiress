...
<body>
    ...
    <div id="in-cont">
        ...
        <div style="padding-top: 50px; padding-bottom: 50px;">
            <h3 style="text-align: center; margin-bottom: 10px;">اسم اللجنة : {{ $committee->name_ar }}</h3>
                        ...
                        <div class="bg-xf5 shadow-primary-sxe position-1lp">
                            <div class="block-osq text-b1x">
                                <figure class="m-38w text-m1o overflow-khm">
                                    {{-- الصورة --}}
                                    <img style="height: 180px; width: 100%;" class="img-odq rou-m3b" src="{{ asset('storage/' . $committee->image) }}" alt="{{ $committee->name_ar ?? 'صورة الخبر' }}">
                                </figure>
                            </div>
                        </div>
                    </div>
                    <div class="col-5vc col-cvg my-mpv">
                        <d href="{{ url('members/councils_members_list', ['id' => $committee->id]) }}" class="block-osq text-b1x">
                            <h2 class="qvtmx font-weight-s3h text-7zo">{{ $committee->name_ar }}</h2>
                        </d>
                        <hr>
                        <div class="my-7z8 fs--oox">
                            <i class="fa fa-calendar"></i>
                            {{ \Carbon\Carbon::parse($committee->created_at)->translatedFormat('Y-m-d') }}
                            <i class="fa fa-clock" style="margin-right: 15px !important;"></i>
                            {{ \Carbon\Carbon::parse($committee->created_at)->translatedFormat('h:i A') }} {{-- تنسيق الوقت صباحا/مساء --}}
                        </div>
