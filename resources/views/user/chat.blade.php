...
<body>
    ...
    <div id="in-cont">
        <div class="inn-title" style="padding-top: 150px">
            <h2><span><a href="{{ url('/') }}">الرئيسية</a> &raquo;</span>اتصل بنا</h2>
        </div>
        		    ...
        		    <div class="address">
        		        <ul>
        		            <li>
        		                ...
        		                <span style="color: #b5dc86 !important;">رقم المكتب: </span> +97167044998
        		            </li>
        		            <li>
        		                <i class="fa fa-mobile" style="color: #b5dc86 !important;"></i>&nbsp;
        		                <span style="color: #b5dc86 !important;">الواتساب: </span> +97167044998
        		            ...
        		            <li>
        		                ...
        		                <span style="color: #b5dc86 !important;">البريد الالكترونى:</span> emiassor@uaeretired.ae
        		            </li>
        		            <li>
        		                أيام العمل :
        		                من الإثنين إلى الخميس، من 8 صباحا إلى 3 ظهرا
        		            </li>
        		            <li>
        		                أيام العطل الرسمية :
        		                لجمعة والسبت والأحد
        		        ...
        		        <section class="social" style="padding: 0px !important; background-color: #a07e6600 !important;">
        		            ...
        		            <ul class="social-set">
        		                <li><a class="sociali" href="#" target="_blank" aria-label="Twitter">
        		                        <i class="fa fa-twitter fa-fw custom-icon" style="color: #b5dc86 !important;"  title="Twitter"></i></a></li>


        		                <li><a class="sociali" href="https://www.instagram.com/uaeretired/" target="_blank" aria-label="Instagram">
        		                        <i class="fa fa-instagram fa-fw custom-icon" style="color: #b5dc86 !important;" title="Instagram"></i></a></li>
        		                <li><a class="sociali" href="https://www.facebook.com/uaeretired/" target="_blank" aria-label="Facebook">
        		                        <i style="color: #b5dc86 !important;"  class="fa fa-facebook-square fa-fw custom-face" title="Facebook"></i></a></li>

        		                <li><a class="sociali" href="https://www.youtube.com/@%D8%AC%D9%85%D8%B9%D9%8A%D8%A9%D8%A7%D9%84%D8%A7%D9%85%D8%A7%D8%B1%D8%A7%D8%AA%D9%84%D9%84%D9%85%D8%AA%D9%82%D8%A7%D8%B9%D8%AF%D9%8A%D9%86" target="_blank" aria-label="Facebook">
        		                        <!-- <i class="fa fa-youtube-square fa-fw" title="Facebook"></i> -->
        		                        <i style="color: #b5dc86 !important;"  class="fa-brands fa-youtube custom-face"></i>
            ...
            fetch(`/messages/${userId}`)
                ...
                .then(messages => {
                    ...
                    messages.forEach(message => {
                        ...
                        const isCurrentUser = message.from_user_id == {{ Auth::id() ?? 'null' }};
        ...
        window.Echo.private(`chat.{{ Auth::id() }}`)
            .listen('MessageSent', (e) => {
                if (currentUserId == e.message.from_user_id || currentUserId == e.message.to_user_id) {
                    ...
                    // تحديد إذا كانت الرسالة مرسلة من المستخدم الحالي أم لا
                    const isCurrentUser = e.message.from_user_id == {{ Auth::id() ?? 'null' }};
